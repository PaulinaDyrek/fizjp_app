  ...
  return (
    <div className="work">
      <div className="main-area">
        ...
        <div className="offer">
          <h1 className="offer__title">Rehabilitacja neuro/ortopedyczna</h1>
          <div className="offer__description">
            <div className="offer__text">
              <p>
                <strong>Rehabilitacja neurologiczna</strong> zwana również
                neurofizjoterapią jest rodzajem fizjoterapii, która koncentruje
                się na leczeniu warunków wpływających na układ nerwowy
                człowieka. Jest stosowana aby pomóc pacjentom odzyskać utracone
                funkcję motoryczne i ruchowe (stawów, mięśni i ścięgien) u osób
                dotkniętych niepełnosprawnością, chorobą lub urazem. Obejmuje to
                poważne schorzenia neurologiczne, takie jak udar mózgu,
                uszkodzenie rdzenia kręgowego, porażenie mózgowe i stwardnienie
                rozsiane, które mogą powodować zaburzenia w sposobie normalnego
                funkcjonowania organizmu. <br />
                <strong>Rehabilitacja ortopedyczna</strong> ma na celu
                przywrócenie funkcji narządu ruchu oraz aktywności życiowych
                utraconych w efekcie wypadków i chorób, a także zmian wrodzonych
                i nabytych układów: kostnego, stawowego oraz mięśniowego.
              </p>
            </div>
            <img className="img__method" src="/offer/neuro.jpg" />
          </div>
