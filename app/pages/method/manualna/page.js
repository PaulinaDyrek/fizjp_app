      ...
      <div className='sidebar'>
        <div className='logo'>
          ...
          <ul className='sidebar__ul'>
            <li className='sidebar__list'><img className='sidebar__img' src='/offer/offer_1.png' alt="" /><Link className='sidebar__link' href='/pages/method/rehabilitacja'><p>Rehabilitacja</p></Link></li>
            <li className='sidebar__list'><img className='sidebar__img' src='/offer/offer_2.png' alt="" /><Link className='sidebar__link' href='/pages/method/manualna'><p>Terapia manualna</p></Link></li>
            <li className='sidebar__list'><img className='sidebar__img' src='/offer/offer_3.png' alt="" /><Link className='sidebar__link' href='/pages/method/neuro-orto'><p>Terapia neuro/orto</p></Link></li>
            <li className='sidebar__list'><img className='sidebar__img' src='/offer/offer_4.png' alt="" /><Link className='sidebar__link' href='/pages/method/wisceralna'><p>Terapia wisceralna</p></Link></li>
            <li className='sidebar__list'><img className='sidebar__img' src='/offer/offer_5.png' alt="" /><Link className='sidebar__link' href='/pages/method/iglowanie'><p>Suche igłowanie</p></Link></li>
            <li className='sidebar__list'><img className='sidebar__img' src='/offer/offer_6.png' alt="" /><Link className='sidebar__link' href='/pages/method/trening'><p>Trening medyczny</p></Link></li>
          </ul>
          <button className='btn-back'><Link className='btn-link'href='/'>Wstecz</Link></button>
      </div>
      <div className='offer'>
        <h1 className='offer__title'>Terapia manualna</h1>
