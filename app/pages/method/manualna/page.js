        ...
        <div className="offer">
          ...
          <div className="offer__description">
            <div className="offer__text">
              <p>
                Terapia manualna jest metodą leczniczo-diagnostyczną polegającą
                na wspomaganiu leczenia schorzeń narządów ruchu, w szczególności
                przy chorobach kręgosłupa oraz zwyrodnieniach stawów.
                Wykorzystywana jest zarówno w ortopedii i rehabilitacji, a także
                reumatologii oraz neurologii. Terapia manualna ma na celu
                przywrócenie właściwej ruchomości stawów oraz zminimalizowanie
                dolegliwości bólowych. Fizjoterapeuta poprzez ucisk odpowiednich
                punktów na ciele, stosując różne techniki terapii tkanek
                miękkich dociera do miejsc bolesnych i przywraca równowagę
                mięśniową. Terapia manualna może być pomocna w leczeniu stawów,
                które nie mają odpowiedniej ruchomości i zakresu ruchu. To
                ograniczenie może powodować dyskomfort, ból, zmianę prawidłowych
                wzorców postawy oraz wzorców ruchowych.
              </p>
            </div>
